...
codeResource.post(
  ...
  adminAuthMiddleware,
  adminMiddleware,
  CodeResourceController.createCodeResource
);

/**
 * @swagger
 * /api/course-resource/get-all:
 *   get:
 *     tags: [CodeResource]
...
codeResource.delete(
  ...
  adminAuthMiddleware,
  adminMiddleware,
  CodeResourceController.deleteCodeResource
);

/**
 * @swagger
 * /api/course-resource/update/{id}:
 *   patch:
 *     tags: [CodeResource]
...
codeResource.patch(
  ...
  adminAuthMiddleware,
  adminMiddleware,
  CodeResourceController.updateCodeResource
);
