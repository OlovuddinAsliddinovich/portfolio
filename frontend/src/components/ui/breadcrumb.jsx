...
const BreadcrumbLink = React.forwardRef(({ asChild, className, ...props }, ref) => {
  ...
  return <Comp ref={ref} className={cn("transition-colors hover:text-foreground text-gray-500 hover:text-200", className)} {...props} />;
});
...
const BreadcrumbPage = React.forwardRef(({ className, ...props }, ref) => (
  <span
    ...
    aria-disabled="true"
    aria-current="page"
    className={cn("font-normal text-foreground text-gray-500", className)}
    {...props}
  />
));
